...
async def search_products(
    ...
    def matches_product(product: Product) -> bool:
        # Get stemmed words from title, description, AND category!
        title_stems = get_stemmed_words(product.title or "")
        desc_stems = get_stemmed_words(product.description or "")
        cat_stems = get_stemmed_words(product.category or "")
        
        # Combine all of them
        all_product_stems = title_stems | desc_stems | cat_stems
